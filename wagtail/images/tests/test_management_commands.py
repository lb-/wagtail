...
class TestUpdateImageRenditions(TestCase):
    ...
    def run_command(self, **options):
        output = StringIO()
        management.call_command("wagtail_update_image_renditions", stdout=output, **options)
        output.seek(0)
    ...
    def test_image_renditions(self):
        ...
        self.assertEqual(output.read(), f'\x1b[32;1mSuccesfully regenerated {total_renditions} image renditions!\x1b[0m\n')
    ...
    def test_image_renditions_with_purge(self):
        ...
        self.assertEqual(output.read(), f"\x1b[32;1mSuccessfully purged and regenerated {total_renditions} image renditions!\x1b[0m\n")
    ...
    def test_image_renditions_with_purge_only(self):
        ...
        self.assertEqual(output.read(), f"\x1b[32;1mSuccessfully purged {total_renditions} image renditions!\x1b[0m\n")
