...
class URLGeneratorView(generic.InspectView):
    ...
    def get(self, request, image_id, *args, **kwargs):
        ...
        if not permission_policy.user_has_permission_for_instance(
            ...
            if self.output_only:
                return HttpResponseForbidden("You do not have permission to generate a URL for this image.")
        ...
        try:
            ...
            return HttpResponseBadRequest(f"Invalid filter spec: `{self.filter_spec}`. {str(e)}.")
    ...
    def get_context_data(self, **kwargs):
        ...
        # Generate url
        signature = generate_signature(image_id, spec)
        url = reverse("wagtailimages_serve", args=(signature, image_id, spec))
        ...
        preview_url = reverse("wagtailimages:preview", args=(image_id, spec))
