...
class TestBreadcrumb(WagtailTestUtils, TestCase):
    ...
    def test_breadcrumb_next_present(self):
        ...
        self.assertContains(response, 'data-controller="w-breadcrumb"')
    ...
    def test_breadcrumb_uses_specific_titles(self):
        ...
        expected = (
            """
            <li class="w-h-full w-flex w-items-center w-overflow-hidden w-transition w-duration-300 w-whitespace-nowrap w-flex-shrink-0 w-font-bold w-max-w-0" data-w-breadcrumb-target="content" hidden>
