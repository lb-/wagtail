    ...
    def test_with_relation(self):
        ...
        expected_html = """
            <select name="users" required id="id_users">
                ...
                <option value="{david}" data-match="{musicians_and_actors}" data-w-cond-target="show">{david_username}</option>
                <option value="{kevin}" data-match="{actors}" data-w-cond-target="show">{kevin_username}</option>
                <option value="{morten}" data-match="{musicians}" data-w-cond-target="show">{morten_username}</option>
            </select>
        """.format(
            david=self.david.pk,
            kevin=self.kevin.pk,
