...
class TestFilteredSelect(TestCase):
    def test_render(self):
        ...
        self.assertHTMLEqual(
            ...
            <select name="country">
                <option value="">----</option>
                <option value="FR" data-w-rules="{&quot;continent&quot;: [null, &quot;EU&quot;]}" data-w-rules-target="enable show">France</option>
                <option value="JP" data-w-rules="{&quot;continent&quot;: [null, &quot;AS&quot;]}" data-w-rules-target="enable show" selected>Japan</option>
                <option value="RU" data-w-rules="{&quot;continent&quot;: [null, &quot;AS&quot;, &quot;EU&quot;]}" data-w-rules-target="enable show">Russia</option>
            </select>
        """,
        )
        ...
        self.assertHTMLEqual(
            ...
            <select name="country">
                ...
                <optgroup label="Small countries">
                    <option value="AZ" data-w-rules="{&quot;continent&quot;: [null, &quot;AS&quot;]}" data-w-rules-target="enable show">Azerbaijan</option>
                    <option value="LI" data-w-rules="{&quot;continent&quot;: [null, &quot;EU&quot;]}" data-w-rules-target="enable show">Liechtenstein</option>
                </optgroup>
                <option value="SK" data-w-rules="{&quot;continent&quot;: [null, &quot;EU&quot;]}" data-w-rules-target="enable show">Slovakia</option>
            </select>
        """,
        )
